...
from pygame import mixer # may require sudo apt-get install libsdl2-2.0-0 libsdl2-mixer-2.0-0 
...
mp3_file = os.path.join(mp3_dir, '01 Crucifucking The Possessed.mp3')
mixer.init()
